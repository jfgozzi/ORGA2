...
void screen_draw_layout(void) {
  ...
  // Limpiar pantalla: fondo azul, texto negro
  for (f = 0; f < VIDEO_FILS; f++) {
    for (c = 0; c < VIDEO_COLS; c++) {
      p[f][c].c = ' ';
      p[f][c].a = C_FG_WHITE | C_BG_BLACK;
    }
  }

  // Escribir nombres del grupo en fila 1
  print("Integrantes de SystemProg_AyOC:", 2, 1, C_FG_WHITE | C_BG_BLACK);
  print("Alejo", 4, 3, C_FG_LIGHT_MAGENTA | C_BG_BLACK);
  print("Jano", 4, 5, C_FG_LIGHT_MAGENTA | C_BG_BLACK);
  print("Juan", 4, 7, C_FG_LIGHT_MAGENTA | C_BG_BLACK);
