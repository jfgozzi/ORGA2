...
_isr14:
    ...
    ; Leer la dirección que causó el page fault desde CR2
    mov eax, cr2
    ...
    ; Si el handler devolvió false (EAX = 0), abortamos
    cmp eax, 0
    je .ring0_exception

    ; Si devolvió true (EAX != 0), continuamos normalmente
    popad
    add esp, 4 ; error code
    iret

.ring0_exception:
    ; Si no se pudo manejar el page fault
    call kernel_exception
    jmp $
