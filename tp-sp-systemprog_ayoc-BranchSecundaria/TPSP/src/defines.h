...
// Segmento de código o datos (S = 1)
#define DESC_CODE_DATA 0x1

// Segmento del sistema (S = 0)
#define DESC_SYSTEM    0x0

// Type = 0xA (1010b): segmento de código, ejecución y lectura, no conforming
#define DESC_TYPE_EXECUTE_READ 0xA

// Type = 0x2 (0010b): segmento de datos, lectura/escritura, expand-up
